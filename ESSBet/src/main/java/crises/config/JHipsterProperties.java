...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "CrisesWeb@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "CrisesWeb API";

        private String description = "CrisesWeb API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "CrisesWeb";
